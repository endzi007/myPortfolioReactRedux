...
import {Drawer, MenuItem, RaisedButton} from '@material-ui/core';
        ...
        <Drawer style={{overflow: "hidden", zIndex: 100}} open={show}>
            <div className={classes.wrapperStyle}>
                <div className={classes.navStyle}>
                    ...
                    <div className={classes.navItemStyle} onClick={handleClick.bind(null, "/Skills")}> <SvgImage show={show} name="skills"/> Skills</div>
