...
const SvgImage = ({name, show, classes})=>{
    ...
    switch (name){
        case "home":
            return(
                <svg className={classes.root} style={defaultStyle(150)} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        case "projects": 
            return(
                <svg className={classes.root} style={defaultStyle(450)}  viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        case "contact":
            return(
                <svg className={classes.root} style={defaultStyle(600)}  viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
